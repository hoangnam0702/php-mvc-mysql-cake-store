                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 mb-sm-45">
                        <div class="footer-block about-us-block">
                            <img src="public/img/logo_white.png" width="125" alt="">
                            <p>Nhóm PTE - Hân hạnh tài trợ chương trình này :))).</p>
...
>                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="footer-block contact-block">
                            <h6>Contact</h6>
                            <ul>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i>Khoa CNTT-TT - Đại học CNTT-TT Việt Hàn.
                                    <br>
            ...
            <div class="container">
                <div class="copyrights">
                    <p class="copyright">&copy; Created by Loan. Responsive Woocommerce Theme 2020</p>
                    <p class="payment">
                        <img src="public/img/payment_logos.png" alt="payment">
                    </p>
                </div>
            </div>
