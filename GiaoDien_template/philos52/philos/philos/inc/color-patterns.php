 ...
 */
function nileforest_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'nileforest_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.nileforest-front-page) .entry-title,
...
.colors-custom .nileforest-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.nileforest-front-page .panel-content .recent-posts article,
...
.colors-custom.nileforest-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'nileforest_custom_colors_css', $css, $hue, $saturation );
}
