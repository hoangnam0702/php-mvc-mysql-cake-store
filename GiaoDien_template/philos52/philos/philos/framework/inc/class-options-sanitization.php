...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'philos' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'philos' ),
		'repeat-y'  => __( 'Repeat Vertically', 'philos' ),
		'repeat'    => __( 'Repeat All', 'philos' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'philos' ),
		'top center'    => __( 'Top Center', 'philos' ),
		'top right'     => __( 'Top Right', 'philos' ),
		'center left'   => __( 'Middle Left', 'philos' ),
		'center center' => __( 'Middle Center', 'philos' ),
		'center right'  => __( 'Middle Right', 'philos' ),
		'bottom left'   => __( 'Bottom Left', 'philos' ),
		'bottom center' => __( 'Bottom Center', 'philos' ),
		'bottom right'  => __( 'Bottom Right', 'philos')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'philos' ),
		'fixed'  => __( 'Fixed in Place', 'philos')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'philos' ),
		'italic'      => __( 'Italic', 'philos' ),
		'bold'        => __( 'Bold', 'philos' ),
		'bold italic' => __( 'Bold Italic', 'philos' )
		);
