...
class SanphamController
{
    ...
    {
        $target_dir = "../public/img/upload/";  // thư mục chứa file upload
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh1 =  "img/upload/" . basename($_FILES["HinhAnh1"]["name"]);
        }
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh2 =  "/img/upload/" . basename($_FILES["HinhAnh2"]["name"]);
        }
        ...
        if ($status_upload) { // nếu upload file không có lỗi 
            $HinhAnh3 =  "/img/upload/" . basename($_FILES["HinhAnh3"]["name"]);
        }
